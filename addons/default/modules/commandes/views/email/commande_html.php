<table width="100%" style="font:Tahoma, Arial, Helvetica, sans-serif; font-size:16px;">
	<tr>
		<td colspan="3"><h3>Vous avez reçu une commande depuis {<?php echo config_item('tags_trigger') ?>:name}</h3></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3">
			Voir la commande:&nbsp;{<?php echo config_item('tags_trigger') ?>:redirect_url}
		</td>
	</tr>
</table>