...
class Newsletters extends Admin_Controller
{
	...
	public function index()
	{
		...
		$this->pagination = create_pagination('admin/newsletters/index', $total_rows);

		// Using this data, get the relevant results
		$newsletters = $this->newsletters_m->get_newsletters( array('order'=>'created_on DESC',
