...
class Admin_fields extends Admin_Controller {
	...
	public function __construct()
	{
		...
		role_or_die('users', 'admin_order_fields');

		$this->load->driver('streams');
		$this->lang->load(array('order', 'order'));
	}
	...
	public function index()
	{
		$buttons = array(
			array(
				'url'		=> 'admin/order/fields/edit/-assign_id-', 
				'label'		=> $this->lang->line('global:edit')
			),
			array(
				'url'		=> 'admin/order/fields/delete/-assign_id-',
	...
	public function create()
	{
		...
		$extra['cancel_uri'] 	= 'admin/order/fields';

		$this->streams->cp->field_form('order', 'order', 'new', 'admin/order/fields', null, array(), true, $extra);
	}
	 ...
	 * Delete
	 *
	 * Delete a custom order profile field.
	 *
	 * @access 	public
	 * @return 	void
	 */
	...
	public function edit()
	{
		...
		$extra = array(
			...
			'show_cancel'	=> true,
			'cancel_uri'	=> 'admin/order/fields'
		);

		$this->streams->cp->field_form('order', 'order', 'edit', 'admin/order/fields', $assign_id, array(), true, $extra);
	}
}