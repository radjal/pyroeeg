...
class Plugin_Contact extends Plugin 
{
	...
	public $description = array(
		...
		'fr' => 'Affiche un formulaire de contact pour les visiteurs.',
		...
		$info = array(
			'form' => array(// the name of the method you are documenting
				'description' => array(// a single sentence to explain the purpose of this method
					...
					'fr' => 'Affiche un formulaire de contact n\'importe où surle site. Chaque wildcard attribué est disponilbe en tant que variable dans le template du mail.',
	...
	public function form()
	{
		...
		$button             = $this->attribute('button', lang('contact_submit_button'));
